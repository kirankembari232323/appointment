...
const DoctorAppointmentForm = () => {
  ...
  const timeSlots = [
    ...generateTimeSlots(12, 18), // 12 PM to 3 PM
    ...generateTimeSlots(18, 22), // 6 PM to 9:30 PM, to include 9:00 PM
  ];

  const filteredSlots = timeSlots.filter((slot) => slot !== "09:30 PM");
  ...
  const updateAvailableSlots = () => {
    ...
    updatedSlots.forEach((slot) => {
      ...
      console.log(`currentTime : ${currentTime} slotTime : ${slotTime}`);
  ...
  const handleBookAppointment = () => {
    ...
    setToastMessage(
      `Appointment booked for ${newAppointment.date} at ${newAppointment.time}.`
    );
    setShowToast(true);
  ...
  return (
    <div className="appointment-form-container">
      <div className="appointment-form-content">
        ...
        <DatePicker
          id="appointmentDate" // Ensure this id matches the label's htmlFor
